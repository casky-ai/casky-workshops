...
When the user hands you a log, email, capture, or dataset:
...
5. Be precise about **exploited vs. exposed-but-unconfirmed** — this lab's Act 3 deliberately
   includes a technique (AS-REP Roasting) that is exposed in the data but not backed by a matching
   event; do not claim it was carried out unless the evidence actually shows it.
